...
TEST(Calculator, simple_test0) {
	EXPECT_EQ(calc.getResult("2"), "2");
}

TEST(Calculator, simple_test1) {
	EXPECT_EQ(calc.getResult("2+2"), "4");
}

TEST(Calculator, simple_test2) {
	EXPECT_EQ(calc.getResult("2+2*2"), "6");
}

TEST(Calculator, simple_test3) {
	EXPECT_EQ(calc.getResult("2*2-4"), "0");
}

TEST(Calculator, simple_test4) {
	EXPECT_EQ(calc.getResult("-2+5"), "3");
}
...
TEST(Calculator, simple_test6) {
	EXPECT_EQ(calc.getResult("10/5"), "2");
}

TEST(Calculator, simple_test7) {
	EXPECT_EQ(calc.getResult("10/5"), "2");
}

TEST(Calculator, simple_test8) {
	EXPECT_EQ(calc.getResult("10%3"), "1");
}

TEST(Calculator, simple_test9) {
	EXPECT_EQ(calc.getResult("-3*7"), "-21");
}

TEST(Calculator, middle_test0) {
	EXPECT_EQ(calc.getResult("(2+2)*2"), "8");
}

TEST(Calculator, middle_test1) {
	EXPECT_EQ(calc.getResult("$0"), "8");
}

TEST(Calculator, middle_test2) {
	EXPECT_EQ(calc.getResult("$0 * $1"), "64");
}

TEST(Calculator, middle_test3) {
	EXPECT_EQ(calc.getResult("$2 + $9"), "43");
}
...
TEST(Calculator, middle_test7) {
    EXPECT_EQ(calc.getResult("-$4"), "1");
}
